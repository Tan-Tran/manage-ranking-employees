...
//        Copy from an exits Profile
    ...
    public String detailsEdit(@RequestParam(value = "page", required = false) Integer page,
                              ...
                              @ModelAttribute("user") UserAccountsLoginDTO userAccountsLoginDTO, Model model, Principal principal) {
        if (page == null) {
            page = 0;
        }
        if (id == null) {
        ...
        userAccountsLoginDTO = userAccountsService.findByEmail(principal.getName());
