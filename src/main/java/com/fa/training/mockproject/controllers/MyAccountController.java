...
public class MyAccountController {
    ...
    public String updatedPhoto(@RequestParam("file") MultipartFile multipartFile, Principal principal,
        ...
        if (userAccountsLoginDTO.getEmployees().getAvatar() != null) {
            File avatar = new File("C:/Users/Admin/Desktop/JAVA/MockProject/Source Code/Source/src/main/resources/static/images/" + userAccountsLoginDTO.getEmail() + "/" + userAccountsLoginDTO.getEmployees().getAvatar());
            avatar.delete();
        }
        String fileName = StringUtils.cleanPath(multipartFile.getOriginalFilename());
        userAccountsLoginDTO.getEmployees().setAvatar(fileName);
        userAccountsService.updateAvatar(userAccountsLoginDTO);
        String uploadDir = "C:/Users/Admin/Desktop/JAVA/MockProject/Source Code/Source/src/main/resources/static/images/" + userAccountsLoginDTO.getEmail();
        try {
    ...
    public byte[] getImg(@ModelAttribute("user") UserAccountsLoginDTO userAccountsLoginDTO) throws IOException {
        ...
        if (userAccountsLoginDTO.getEmployees().getAvatar() == null || userAccountsLoginDTO.getEmployees().getAvatar().equals("")) {
            file = new File("D:/Mock_Project/mock-project/src/main/resources/static/images/default-picture.png");
        } else {
            file = new File("D:/Mock_Project/mock-project/src/main/resources/static/images/" + userAccountsLoginDTO.getEmail() + "/" + userAccountsLoginDTO.getEmployees().getAvatar());
        }
